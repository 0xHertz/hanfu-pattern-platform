...
export const DAOPAO_SIZES: GarmentSize[] = [
...
export interface DaopaoDimensions {
...
export function calculateDaopao(
  height: number,
  bust: number,
  ease: number = 140
): DaopaoDimensions {
  ...
  return {
    ...
    cuffWidth: Math.round(bust * 0.45),
    armSpan: Math.round(height * 1.25),
