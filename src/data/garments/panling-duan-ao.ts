...
export const PANLING_DUAN_AO_SIZES: GarmentSize[] = [
...
export interface PanlingDuanAoDimensions {
...
export function calculatePanlingDuanAo(
  height: number,
  bust: number,
  ease: number = 100
): PanlingDuanAoDimensions {
  ...
  return {
    ...
    armSpan: Math.round(height * 1.05),
